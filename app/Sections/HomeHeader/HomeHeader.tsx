...
import Img from "../../assets/itachi-1.png";
      ...
      <div className="lg:px-6">
        <div className="p-3 space-y-2 lg:grid lg:grid-cols-2 lg:gap-x-6 lg:space-y-0">
          ...
          <div className="pl-3 max-w-xl lg:py-16">
            ...
            <div className="text">
              ...
              >
                Custom AI Tools for <span className="underline">Otakus</span>.
              </h1>
              <p
              ...
              >
                ...
                Tools to Share Your Knowledge and Empower You and Your Clients.
                Our AI Builder`s easy-to-use interface makes building AI tools
                enjoyable, even for non-technical Prompt Engineers. The
                dedicated support team is available for troubleshooting and
                guidance, helping users overcome technical obstacle
              </p>
            </div>
        ...
        {/* <div className="p-5">
          ...
          <div className="flex">
            ...
            <div className="">
              {" "}
              <Image src={Proptter} alt="Proptter" className="h-10 w-24 m-3" />
            </div>
          </div>
        </div> */}
      </div>
